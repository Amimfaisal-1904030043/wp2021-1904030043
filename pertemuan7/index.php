...
<html lang="en">
    ...
    <div class="row ">
      <div class="col-md-2 bg-secondary ">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="#"><i class="fas fa-users"></i> Calon Mahasiswa</a><hr class="bg-dark">
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="#"><i class="far fa-calendar-alt"></i> Jadwal Kuliah</a><hr class="bg-dark">
          </li>
        </ul>
      </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <img src="<?php echo $camaba['foto_maba']; ?>" alt="" width="100px" height="100px"> </td>
      <td><i class="far fa-edit"></i> || <i class="fas fa-user-minus"></i></td>
    </tr>
    <?php $no++ ?>
    <?php }?>
  </tbody>
