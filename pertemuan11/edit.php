    ...
    <div class="row mt-4">
        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <form method="POST" action="">
                <input type="hidden" class="form-control" id="id" name="id" value="<?= $camaba['id'] ?>">
                <div class="mb-3">
                    <label for="nama" class="form-label">Nama : </label>
                    <input type="text" class="form-control" id="nama" placeholder="nama lengkap" name="nama" autofocus required autocomplete="off" value="<?= $camaba['nama'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="jk" value="<?= $camaba['jenis_kelamin'] ?>" placeholder="Jenis Kelamin" name="jenis_kelamin" required autocomplete="off">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="as" value="<?= $camaba['sekolah_asal'] ?>" placeholder="Asal Sekolah anda" name="sekolah_sasal" required autocomplete="off">
                </div>
                <div class="mb-3">
                    <label for="fm" class="form-label">Foto maba : </label>
                    <input type="text" class="form-control" id="fm" value="<?= $camaba['foto_maba'] ?>" placeholder="input foto anda" name="foto_maba" required autocomplete="off">
                </div>
